 ...
 */
package com.metamug.exec.event;
 ...
 * component, using the component's addActionListener method. When the action event occurs, that object's actionPerformed method is invoked
 *
 * @author Kaisteel
 */
